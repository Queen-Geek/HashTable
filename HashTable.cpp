...
void HashTable::Remove(string bidId) {
  ...
  unsigned bidKey = hash(atoi(bidId.c_str()));

  // Erase node with matching bidKey value
	nodes.erase(nodes.begin() + bidKey);
...
Bid HashTable::Search(string bidId) {
  ...
  // if no entry found for the key at start of node search
...
int main(int argc, char* argv[]) {
  ...
  switch (argc) {
    ...
    case 3:
      ...
      break;
    default:
      csvPath = "CS 300 Hash Table Assignment Student Files/eBid_Monthly_Sales_Dec_2016.csv";
      bidKey = "98223";
  }
